...
QT_MOC_LITERAL(1, 7, 22), // "independentLegProgress"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "progress"
QT_MOC_LITERAL(4, 40, 8) // "lastPage"

    },
    "Merger\0independentLegProgress\0\0progress\0"
    "lastPage"
};
...
void Merger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->independentLegProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->lastPage(); break;
        default: ;
        }
        ...
        {
            typedef void (Merger::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Merger::independentLegProgress)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Merger::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Merger::lastPage)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Merger::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Merger.data,
      qt_meta_data_Merger,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Merger::independentLegProgress(int _t1)
{
